...
<div class="modal" bind:this={modalRoot} class:red={result[1] === 1} class:blue={result[1] === 0} class:grey={result[1] === 2} in:fly={{y: 50, duration: 250}}>
  ...
  <div class="mapContainer">
    <a href="#DisconnectButton" class="skipMap" tabindex="0" rel=external on:click|preventDefault={() => { disconnectButton.focus(); }}>SKIP MAP</a>
    <Map {result} />
  </div>
  <div class="message">
    {#if result[0] === 0}
  ...
  <div class="buttons">
    <button class="disconnect" title="Disconnect" on:click={handleDisconect} id="DisconnectButton" bind:this={disconnectButton}>
